    ...
    return (
        <>
            <div style={{
                ...
                <IconButton aria-label="exit" onClick={props.pass} sx={{fontSize:"30px", color: "#CAD6FF", transform: 'rotate(-180deg)', alignSelf: "center", marginTop: "10px", marginLeft:"5px", marginRight:"-10px" }}><LogoutIcon/></IconButton>
